...
//  echo $commandline;
  ...
  foreach($outputArr as $line){
    if(!empty($line)){
      ...
      else { echo "<tr><td>{$item[0]}</td><td><a href=hornwortbase.php?transcript={$item[1]}>{$item[1]}</a></td>"; }
...
<div id="content" align="center">
 <a href="hornwortbase.php">Search</a> | <a href="downloads.html">Download Files</a> | <a href="extract.php">Extract sequence</a>
</div>
<div id="content" align="center">
<h3>BLAST search of hornworts</h3>
...
<body>
  ...
  <form method="post" action="blast.php" enctype="multipart/form-data">
   ...
   <select name="seqtype" id="seq-select">
    ...
    <option value="PROT">Protein sequences</option>
